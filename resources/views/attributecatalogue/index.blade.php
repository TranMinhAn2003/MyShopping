        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                            ...
                            <div class="row">
                                <div class="col-lg-6 hr ">
                                    <div class="form-row hf">
                                        <div class="create">
                                            <a  href="{{route('attributecatalogue.create')}}" class="btn btn-primary mb-5 "> <i class="fa fa-plus" ></i> Thêm mới thuộc tính </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                    @foreach($attributeC as $index => $attribute)
                        <tr>
                            <td class="text-center"> {{ $loop->iteration }}</td>
                            <td class="text-center">{{$attribute->name}}</td>
                            <td class="text-center ">
                                <a href="{{route('attributecatalogue.edit',$attribute->id)}}" class=" btn btn-success btnedit "><i class="fa fa-edit"></i></a>
                            </td>

                            <td class="text-center ">
                                <form action="{{route('attributecatalogue.destroy',$attribute->id)}}" method="post">
                                    @csrf
                                    @method('DELETE')
