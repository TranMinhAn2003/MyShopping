...
(function() {
  ...
  MT("eviltest",
     ...
     "          [keyword attributecatalogue] [variable attributecatalogue] { [atom 1] },",
     "          [keyword element] [variable test] { [variable &#39;a&#39;] },           [keyword attributecatalogue] [variable foo] { [variable &quot;bar&quot;] },",
     ...
     "      [keyword return] [keyword element] [variable element] {",
     "          [keyword attributecatalogue] [variable attributecatalogue] { [keyword try] { [def&variable xdmp:version]() } [keyword catch]([variable $e]) { [def&variable xdmp:log]([variable $e]) } },",
     "          [keyword attributecatalogue] [variable fn:doc] { [variable &quot;bar&quot;] [variable castable] [keyword as] [atom xs:string] },",
     "          [keyword element] [variable text] { [keyword text] { [variable &quot;text&quot;] } },",
     "          [def&variable fn:doc]()[[ [qualifier child::][variable eq][keyword /]([variable @bar] [keyword |] [qualifier attributecatalogue::][variable attributecatalogue]) [keyword eq] [variable $let] ]],",
  ...
  MT("testMultiAttr",
     "[tag <p ][attributecatalogue a1]=[string \"foo\"] [attributecatalogue a2]=[string \"bar\"][tag >][variable hello] [variable world][tag </p>]");
