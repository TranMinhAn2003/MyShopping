...
(function() {
  ...
  MT("selfclose",
     ...
     "  [tag&bracket <][tag link] [attributecatalogue rel]=[string stylesheet] [attributecatalogue href]=[string \"/foobar\"][tag&bracket >]",
     "[tag&bracket </][tag html][tag&bracket >]");
  ...
  MT("valueless",
     "[tag&bracket <][tag input] [attributecatalogue type]=[string checkbox] [attributecatalogue checked][tag&bracket />]");
