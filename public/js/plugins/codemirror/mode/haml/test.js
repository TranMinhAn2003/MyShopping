...
(function() {
  ...
  MT("idSelector",
     "[tag %h1][attributecatalogue #test] Hey There");

  MT("classSelector",
     "[tag %h1][attributecatalogue .hello] Hey There");
  ...
  MT("hamlAfterRubyTag",
    "[attributecatalogue .block]",
    "  [tag %strong=] [variable now]",
    "  [attributecatalogue .test]",
    "     [operator =][variable now]",
    "  [attributecatalogue .right]");
